...
console.log('🎨 ZenCSS - Modern CSS Features Demo\n')
console.log('============================================================\n')
...
console.log('📚 1. CASCADE LAYERS (@layer)')
console.log('------------------------------------------------------------')
...
console.log(`:where(.button):         [${whereSpec.join(', ')}] (0,0,0) ⬅ ZERO!`)

console.log('\nWhy this matters:')
console.log('✅ Easy to override: any class beats :where()')
console.log('✅ No specificity conflicts')
console.log('✅ Cleaner cascade')
console.log('✅ Modern best practice')

console.log('\nExample override:')
console.log('```css')
console.log(':where(.zen-button) { color: blue; }  /* Generated by ZenCSS */')
...
console.log('\n\n⚡ 3. OPTIMIZED SELECTOR GENERATION')
console.log('------------------------------------------------------------')
...
for (const key of classes) {
  ...
  console.log(`${key.padEnd(20)} → ${className.padEnd(15)} → ${selector}`)
...
for (let i = 0; i < 5; i++) {
  ...
  console.log(`property-${i}`.padEnd(15) + ' → ' + className)
}
...
completeManager.add(':where(.zen-p4) { padding: 1rem; }', 'utilities')
completeManager.add(':where(.zen-m2) { margin: 0.5rem; }', 'utilities')
completeManager.add(':where(.zen-text-red) { color: red; }', 'utilities')
